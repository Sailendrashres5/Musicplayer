...
<nav class="main-header flex mt-3">
    ...
    <div class="mx-auto mt-4 w-half">
        <form id="edit_genre_form" class="flex flex-cols items-center justify-center gap-2">
            <label class="block w-75 text-size18" for="genre_name">Genre Name</label>
            <input type="text" class="input block w-75" name="artist" id="genre_name" placeholder="Enter name of the Genre" />
            ...
            <button type="submit" class="btn-3 block w-75 mt-1">Update Genre</button>
        </form>
    </div>
</div>
