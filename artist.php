...
$artist_groups = $artist->getAllArtists();
...
<main class="music_wrapper" id="main_music_wrapper">
  ...
  <section class="main_wrapper" aria-label="container">
    <div class="flex justify-between items-center">
      <h1 class="poppins greetings text-size32"> Artists </h1>
      <input id="artist_searchbar" type="text" class="search-bar" placeholder="Search..." style="margin-right:0!important;">
    </div>
    <div class="home-song-container snap-inline">

      <div class="song-container" id="artist_wrapper_home">
        <?php foreach ($artist_groups as $group) : ?>

          <a href="./artist_page.php?id=<?php echo $group["id"]; ?>" class="song-wrapper card-height">
